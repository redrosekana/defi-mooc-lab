...
describe("LiquidationOperator3", function () {
  ...
  it("Test flash loan with 8300 USDC so that liquidate", async function () {
    ...
    const LiquidationOperator3 = await ethers.getContractFactory("LiquidationOperator3");
    const liquidationOperator = await LiquidationOperator3.deploy(usdtValue,overrides = {gasPrice: gasPrice});
